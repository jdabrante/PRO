...
def order_weight (strng: str)-> str:
    ...
    weight_value_list = sorted([(value,weight) for weight,value in zip(weight_list,number_list)])
    return " ".join([value[1] for value in weight_value_list])
